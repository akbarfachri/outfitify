          ...
          <View style={styles.formWrapper}>
              ...
              <View style={styles.bodyWrapper}>
                  ...
                  <View style={styles.logTitleWrapper}>
                      <Text style={styles.logTitle}>Create Account</Text>  
                  ...
                  <View style={styles.inputWrapper}>
                   ...
                   <View style={styles.accountWrapper}>
                      <Text style={styles.accountText}>By Clicking Create Now, you agree to our <Text onPress={this.signup} style={[styles.textRed, styles.textBold]}>Term of Service</Text> and that you have read our <Text onPress={this.signup} style={[styles.textRed, styles.textBold]}>Privacy Policy</Text></Text> 
                   </View> 
              </View>
